  ...
  return (
    <div className='min-h-screen flex items-center justify-center p-4'>
      <form onSubmit={handle} className='card p-8 w-full max-w-md'>
        ...
        <input required value={name} onChange={e=>setName(e.target.value)} placeholder='Name' className='mb-3 p-3 border rounded w-full' />
        ...
        <button className='w-full p-3 rounded bg-accent text-white'>Register</button>
      </form>
    </div>
  );
}
